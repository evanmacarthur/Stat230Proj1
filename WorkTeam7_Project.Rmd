...
The initial combining, and wrangling of this large data set can be found at https://github.com/evanmacarthur/Stat230Proj1. The data was then finished in appendix 1
...
```{r wrangling good ag data, eval=FALSE}
df0 <- read_csv("gooddata.csv")
df0 <- df0 |> 
  clean_names()
df0 <- df0 |> 
